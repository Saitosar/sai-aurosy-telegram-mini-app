      ...
      <div className="relative z-10 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3">
          <motion.button
            ...
            className="w-full py-3 px-4 glass-button-secondary text-foreground font-medium rounded-xl flex items-center justify-center gap-2 hover:bg-muted/50 transition-colors disabled:opacity-70"
            whileTap={{ scale: 0.99 }}
          >
