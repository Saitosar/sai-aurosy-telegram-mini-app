...
import { Bot, Store, MapPin, ArrowRight } from "lucide-react";
            ...
            <div className="bg-[#111111]/80 backdrop-blur-sm border border-white/5 rounded-2xl p-6 hover:border-primary/30 transition-all group shadow-lg">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#a0a0a0] text-[13px] leading-relaxed">View, manage, and monitor the health of your robotic fleet in real-time.</p>
                </div>
              </div>
            </div>
          </Link>
            ...
            <div className="bg-[#111111]/80 backdrop-blur-sm border border-white/5 rounded-2xl p-6 hover:border-primary/30 transition-all group shadow-lg">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#a0a0a0] text-[13px] leading-relaxed">Browse new models, upgrade capabilities, and scale your automated workforce.</p>
                </div>
              </div>
            </div>
          </Link>
            ...
            <div className="bg-[#111111]/80 backdrop-blur-sm border border-white/5 rounded-2xl p-6 hover:border-primary/30 transition-all group shadow-lg">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#a0a0a0] text-[13px] leading-relaxed">Deploy interactive wayfinding, automate patrols, and manage spatial data.</p>
                </div>
              </div>
            </div>
          </Link>
